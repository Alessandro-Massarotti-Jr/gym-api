...
const createaccountSchema = z.object({
    ...
    password: z.string({ required_error: "Senha é obrigatorio", invalid_type_error: "Senha deve ser uma string" }).min(8, "senha deve possuir no minimo 8 caracteres"),
    name: z.string({ required_error: "Nome é obrigatorio", invalid_type_error: "Nome deve ser uma string" })
});
